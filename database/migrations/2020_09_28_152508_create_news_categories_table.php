...
class CreateNewsCategoriesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('news_categories', function (Blueprint $table) {
            ...
            $table->foreign('existing_record_id')->references('id')->on('news_categories')->onUpdate('cascade')->onDelete('cascade');
            $table->foreign('parent_id')->references('id')->on('news_categories')->onUpdate('cascade')->onDelete('cascade');
