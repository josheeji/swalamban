...
class CreateBranchDirectoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('branch_directories', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('existing_record_id')->references('id')->on('branch_directories')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('branch_directories');
    }
}
