...
<section class="inner-content">
    <div class="container">
        ...
        <p><a href="http://project.peacenepal.com/sana-kishan/public/syllabus">Click to Download Syllabus </a></p>
                ...
                <div class="table-responsive">
                    <table id="branchlist" class="table table-striped table-bordered ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="#">{{ $download->title }}</a> <br><small style="padding-left: 20px;"><i class="bi bi-calendar-check" style="margin-top: -1px;position: absolute;margin-left: -20px;"></i> {{ Helper::formatDate($download->published_date,6) }}
                                    </small></td>
