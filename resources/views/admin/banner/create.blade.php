...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
            <a href="{{ route('admin.banner.index') }}" class="btn btn-default btn-outline-success font-weight-bolder">Back</a>
        </div>
        <!--end::Toolbar-->
    </div>
</div>
                        ...
                        <div class="tab-content mt-5">
                            ...
                            <div id="aa-{{ $language['id'] }}" class="tab-pane fade in {{ ($count == 0) ? 'active show' : '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('caption['.$language['id'].']', null, array('class'=>'form-control', 'rows' => 3, 'maxlength' => '255')) !!}
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Button Text</label>
                                    {!! Form::text('link_text['.$language['id'].']', null, array('class'=>'form-control')) !!}
                                </div>
                            </div>
                            @php
                            $count++;
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="checkbox-inline">
                                <label class="checkbox checkbox-lg">
                                    <input type="checkbox" name="show_block" value="1">
                                    <span></span>Show content block on banner
                                </label>
                            </div>
                        </div>
                    </div>
