...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
            ...
            <a title="Create Content" href="{{ route('admin.career.create') }}" class="btn btn-default btn-outline-success font-weight-bolder">Create New</a>
            @endif
        </div>
        <!--end::Toolbar-->
    </div>
            ...
            <div class="card-body">
                <div class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded" id="kt_datatable">
                    <table class="table datatable-column-search-inputs defaultTable">
                        ...
                        <tbody id="sortable">
                            @can('master-policy.perform', ['career', 'edit'])
                            @php $edit_access = 1; @endphp
                            @endcan
                            @can('master-policy.perform', ['career', 'delete'])
                            @php $delete_access = 1; @endphp
                            @endcan
                            @can('master-policy.perform', ['career', 'changeStatus'])
                            ...
                            <tr id="item-{{ $item->id }}">
                                <td>{{ $index+1 }}</td>
                                <td>{{ $item->title }}</td>
                                <td>{{ Helper::formatDate($item->publish_from) }}</td>
                                <td>{{ Helper::formatDate($item->publish_to) }}</td>
                                <td>
                                ...
                                <td class="text-center">
                                    ...
                                    <a title="Edit" href="{{ route('admin.career.edit',$item->id) }}" class="btn btn-icon btn-light"><i class="la la-pencil"></i></a>
                                    @endif
