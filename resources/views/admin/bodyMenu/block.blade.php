<div class="card-block" data-index="{{ $index }}">
    <div class="panel">
        <div class="panel-heading">
            {{--<h5 class="panel-title"><i class="icon-file-plus position-left"></i><a--}}
                        {{--class="heading-elements-toggle"><i class="icon-more"></i></a></h5>--}}
            <div class="heading-elements" style="margin-left: 1%">
                <a href="javascript:void(0)" class="btn btn-danger btn-icon btn-rounded btn-remove-block-{{ $index }}"
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" name="contact[{{ $index }}][contact_person]"
                           class="form-control">{{ isset($block) ? $block->contact_person : '' }}</input>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-lg-2">Contact Number</label>
                    ...
                    <input type="number" name="contact[{{ $index }}][contact_number]"
                           class="form-control">{{ isset($block) ? $block->contact_number : '' }}</input>
                </div>
            </div>
        </div>
    </div>
