...
<script>
    $(document).ready(function () {
            ...
            fields: {
                ...
                meta_title: {
                 ...
                 keywords: {
                    validators: {
                        notEmpty: {
                            message: 'Key Words are required'
                        }
                    }
                },
        ...
        $('#meta_title').NobleCount('#counttitle', {
          ...
          $('#keywords').NobleCount('#countkeywords', {
            max_chars: 70,
            block_negative: true
        });
    ...
    <div class="panel-body">
        ...
        <fieldset class="content-group">
            ...
            <div class="clearfix"></div>
              ...
              <div class="form-group">
                <label class="control-label col-lg-2">Key Words</label>
                <div class="col-lg-6">
                    {!! Form::textarea('key_words', null, array('class'=>'form-control m-input','placeholder'=>'Key Words','rows'=>3,'id'=>'meta_title')) !!}
                    <p class="text-primary">You have <span id="counttitle">70</span> characters left. </p>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="control-label col-lg-2">JSON LD<span class="text-danger"></span></label>

               <div class="col-lg-10">
                {!! Form::textarea('json_description', null, array('class'=>'form-control mini-editor','placeholder'=>'JSON LD')) !!}
            </div> 
        </div> 
        <div class="clearfix"></div> 
