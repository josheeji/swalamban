...
@section('title', 'Internal Web Categories - create')
@section('styles')
...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
            <a href="{{ route('admin.internal-web-category.index') }}" class="btn btn-default btn-outline-success font-weight-bolder">Back</a>
        </div>
        <!--end::Toolbar-->
    </div>
</div>
...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container-fluid">
        {!! Form::open(array('route' => 'admin.internal-web-category.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')) !!}
        <div class="row">
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="checkbox-inline">
                                <label class="checkbox checkbox-lg">
                                    <input type="checkbox" name="show_upload_file" value="0">
                                    <span></span>Show Upload File?</label>
                            </div>
                        </div>
                        <div class="form-group new">
                            ...
                            <select name="parent_id" class="form-control">
                                ...
                                @include('admin.internalWebCategory.recursive_options', ['parents' => $parents, 'selected_id' => ""])
                            </select>
                        </div>
                    </div>
                </div>
