...
@section('title', 'Downloads - create')
@section('scripts')
<script>
    $(function() {
...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container-fluid">
        {!! Form::open(array('route' => 'admin.syllabus.store','class'=>'form-horizontal','id'=>'syllabus', 'files' => 'true')) !!}
        <div class="row">
                        ...
                        <div class="tab-content mt-5">
                            ...
                            <div id="aa-{{ $language['id'] }}" class="tab-pane fade in {{ ($count == 0) ? 'active show' : '' }}">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('category['.$language['id'].']', null, array('class'=>'form-control')) !!}
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Designation<span class="text-danger">*</span></label>
                                    {!! Form::text('designation['.$language['id'].']', null, array('class'=>'form-control')) !!}
                                </div>
                            </div>
                            @php
                            $count++;
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control">
                                <option value="1" {{ old('type') == 1?'selected':'' }}>खुला</option>
                                <option value="2" {{ old('type') == 2?'selected':'' }}>आ.प्र.</option>
                            </select>
                        </div>
                        <div class="form-group">
