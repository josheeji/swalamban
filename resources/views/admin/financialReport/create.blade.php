...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container-fluid">
        {!! Form::open(array('route' => 'admin.financial-report.store','class'=>'form-horizontal','id'=>'validator',
        'files' => 'true')) !!}
        <div class="row">
                        ...
                        <div class="tab-content mt-5">
                            ...
                            <div id="aa-{{ $language['id'] }}"
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('title['.$language['id'].']', null,
                                    array('class'=>'form-control','placeholder'=>'Download title')) !!}
                                </div>
                            </div>
                            @php
                            $count++;
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="company_id" class="form-control" required>
                                ...
                                <option value="1">Surya Jyoti Life</option>
                                <option value="2">Surya Life</option>
                                <option value="3">Jyoti Life</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <span class="text-muted  small">only jpg, jpeg, png, doc, docx and pdf format are
                                allowed.</span>
                            <br>
