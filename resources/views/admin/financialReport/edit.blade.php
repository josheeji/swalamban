...
@section('title', 'Financial Reports - ' . $report->title)
@section('scripts')
<script>
...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
            <a href="{{ route('admin.financial-report.index') }}" class="btn btn-outline-success font-weight-bolder">Back</a>
        </div>
        <!--end::Toolbar-->
    </div>
</div>
...
<div class="d-flex flex-column-fluid">
    ...
    <div class=" container-fluid">
        {!! Form::open(array('route' => ['admin.financial-report.update', $report->id],'class'=>'form-horizontal','id'=>'validator', 'files' => 'true','novalidate')) !!}
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="card card-custom gutter-b">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="control-label">Select Company <span class="text-danger">*</span></label>
                            <select name="company_id" class="form-control" required>
                                <option value="">Select Company </option>
                                <option value="1" {{ $report->company_id == 1 ? 'selected' : '' }}>Surya Jyoti Life</option>
                                <option value="2" {{ $report->company_id == 2 ? 'selected' : '' }}>Surya Life</option>
                                <option value="3" {{ $report->company_id == 3 ? 'selected' : '' }}>Jyoti Life</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Publish Date <span class="text-danger">*</span></label>
                            {!! Form::date('published_date', $report->published_date, array('class'=>'form-control')) !!}
                        </div>

                        @if(file_exists('storage/'.$report->file) && $report->file != '')
                        <div class="mb-2">
                            <div class="bg-gray-300 my-2 px-3 py-2"><small>Existing Financial Report Preview</small></div>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <span class="text-muted  small">Image size should not be greater than 32MB.</span>
