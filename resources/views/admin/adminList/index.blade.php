                    ...
                    <table class="table datatable-column-search-inputs defaultTable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="130s">Action</th>
                            </tr>
                        </thead>
                        <tfoot>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.admin-list.edit',$item->id) }}" class="btn btn-icon btn-light btn-circle"><i class="la la-pencil"></i></a>
                                    <a href="javascript:void(0)" id="{{ $item->id }}" data-user_type_id="{{ $adminTypeId }}" class="btn btn-icon btn-danger delete btn-circle"><i class="la la-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
