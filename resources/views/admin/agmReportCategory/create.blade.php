...
@section('title', 'AGM Categories - create')
@section('styles')
...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">AGM Report Category</h5>
            <!--end::Page Title-->
            <!--begin::Actions-->
...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container-fluid">
        {!! Form::open(array('route' => 'admin.agm-report-category.store','class'=>'form-horizontal','id'=>'validator', 'files' => 'true')) !!}
        <div class="row">
                        ...
                        <div class="tab-content mt-5">
                            ...
                            <div id="aa-{{ $language['id'] }}" class="tab-pane fade in {{ ($count == 0) ? 'active show' : '' }}">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('title['.$language['id'].']', null, array('class'=>'form-control','placeholder'=>'Category title')) !!}
                                </div>
                            </div>
                            @php
                            $count++;
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="parent_id" class="form-control">
                                ...
                                @include('admin.downloadCategory.recursive_options', ['parents' => $parents, 'selected_id' => ""])
                            </select>
                        </div>
                    </div>
                </div>
