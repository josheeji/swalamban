    ...
    <div class="page-header-content">
        <div class="page-title">
            <h4>
                ...
                case 'oversea-alliance':
                $type = 'overseas';
                break;
                case 'kumari-paying-alliance':
                $type = 'kumari-paying-alliance';
                break;
                case 'remit-service':
                $type = 'remit-service';
                break;
                ...
                @endphp
                <a title="Create Remittance" href="{{ route('admin.remittance.create', ['type' => $type]) }}" class="btn btn-default legitRipple pull-right">
        ...
        <table class="table datatable-column-search-inputs defaultTable">
            ...
            <tbody id="sortable">
                ...
                <tr id="item-{{ $item->id }}">
                    <td>{{ $key  + 1 }}</td>
                    <td>{!! $item->title !!}</td>
                    <td>{!! !empty($item->parent_id) ? $item->parent->title : '' !!}</td>
