...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">ATM Location</span>
            <!--end::Actions-->
        </div>
        <!--end::Info-->
        ...
        <div class="row">
            <div class="col-12 col-md-8">
                <div class="card card-custom gutter-b">
                    <div class="card-body">
                        {!! Form::open(array('route' => 'admin.import.store-atm','class'=>'form-horizontal','id'=>'download', 'files' => 'true')) !!}
            ...
            <div class="col-12 col-md-4">
                <a href="{{ asset('backend/samples/atm-location-sample.xlsx') }}" class="btn btn-icon btn-circle btn-primary float-right mr-1" title="Sample File"><i class="las la-file-excel"></i></a>
            </div>
        </div>
    </div>
</div>
