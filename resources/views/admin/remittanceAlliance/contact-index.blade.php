    ...
    $(".defaultTable").on("click", ".delete", function() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: baseUrl + "/admin/remittance-alliance-contact" + "/" + id,
                    data: {
                        id: id,
                        _method: 'DELETE'
                    },
            ...
            <tbody id="sortable">
                ...
                <tr id="item-{{ $item->id }}">
                    ...
                    <td class="text-center">
                        <a title="View" href="{{ route('admin.remittance-alliance-contact.show',$item->id) }}" class="btn btn-success btn-icon btn-circle legitRipple">
                            <i class=" icon-eye"></i>
                        </a>
