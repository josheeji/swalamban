...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4>
                ...
                <a href="{{ route('admin.remittance-alliance-contact.index') }}" class="btn btn-default legitRipple pull-right">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="{{ route('admin.remittance-alliance-contact.index') }}">{{ $title }}</a></li>
