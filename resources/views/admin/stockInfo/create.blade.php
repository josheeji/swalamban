...
@section('title', 'Stock Watch - create')
@section('scripts')
<script>
...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
            <a href="{{ route('admin.stock-watch.index') }}" class="btn btn-default btn-outline-success font-weight-bolder">Back</a>
        </div>
        <!--end::Toolbar-->
    </div>
</div>
...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container-fluid">
        {!! Form::open(array('route' => 'admin.stock-watch.store','class'=>'form-horizontal','id'=>'stock-watch', 'files' => 'true')) !!}
        <div class="row">
                        ...
                        <div class="tab-content mt-5">
                            ...
                            <div id="aa-{{ $language['id'] }}" class="tab-pane fade in {{ ($count == 0) ? 'active show' : '' }}">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('paidup_value['.$language['id'].']', null, array('class'=>'form-control')) !!}
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Maximum<span class="text-danger">*</span></label>
                                    {!! Form::text('maximum['.$language['id'].']', null, array('class'=>'form-control')) !!}
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Minimum<span class="text-danger">*</span></label>
                                    {!! Form::text('minimum['.$language['id'].']', null, array('class'=>'form-control')) !!}
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Closing<span class="text-danger">*</span></label>
                                    {!! Form::text('closing['.$language['id'].']', null, array('class'=>'form-control')) !!}
                                </div>
                                <div class="form-group">
                                    <label class="control-label">No. of Traded Shares<span class="text-danger">*</span></label>
                                    {!! Form::text('traded_share['.$language['id'].']', null, array('class'=>'form-control')) !!}
                                </div>
                            </div>
                            @php
                            $count++;
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="published_at" value="{{ date('Y-m-d') }}">
                        </div>
                        <div class="form-group">
