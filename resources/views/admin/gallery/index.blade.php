...
@section('title', 'Galleries - manage')
@section('styles')
...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
            ...
            <a title="Create Content" href="{{ route('admin.gallery.create') }}" class="btn btn-default btn-outline-success font-weight-bolder">Create New</a>
            @endif
        </div>
        <!--end::Toolbar-->
    </div>
                        ...
                        <tbody id="sortable">
                            ...
                            <tr id="item-{{ $item->id }}">
                                ...
                                <td class="text-center">
                                    ...
                                    <a title="Upload Images" href="{{ route('admin.gallery-image.index', [$item->id])}}" class="btn btn-success btn-icon btn-circle"><i class="la la-photo"></i></a>
                                    <a title="Edit" href="{{ route('admin.gallery.edit',$item->id) }}" class="btn btn-icon btn-light btn-circle"><i class="la la-pencil"></i></a>
                                    @endif
