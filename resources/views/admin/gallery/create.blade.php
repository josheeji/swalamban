                        ...
                        <div class="tab-content mt-5">
                            ...
                            <div id="aa-{{ $language['id'] }}" class="tab-pane fade in {{ ($count == 0) ? 'active show' : '' }}">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    {!! Form::textarea('description['.$language['id'].']', null, array('class'=>'form-control editor', 'id'=>'editor', 'required' => 'true')) !!}
                                </div> -->
                            </div>
                            @php
                            $count++;
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <span class="text-muted float-right small">Preferred size: 800px / 600px</span>
