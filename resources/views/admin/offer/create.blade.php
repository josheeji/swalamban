...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
            <a href="{{ route('admin.offers.index') }}" class="btn btn-outline-success font-weight-bolder">Back</a>
        </div>
        <!--end::Toolbar-->
    </div>
</div>
...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container-fluid">
        {!! Form::open(['route' => 'admin.offers.store', 'class' => 'form-horizontal', 'id' => 'validator', 'files' =>
        'true']) !!}
        <div class="row">
                        ...
                        <div class="tab-content mt-5">
                            ...
                            <div id="aa-{{ $language['id'] }}"
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    {!! Form::text('layout[' . $language['id'] . ']', null, ['class' => 'form-control'])
                                    !!}
                                </div> --}}
                                <div class="form-group">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="banner" id="banner-file" required>
