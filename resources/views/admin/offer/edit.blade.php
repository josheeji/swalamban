...
@section('title', 'Offers - ' . $offer->title)
@section('styles')
...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">{!! $offer->title !!}</span>
            <!--end::Actions-->
        </div>
        <!--end::Info-->
        ...
        <div class="d-flex align-items-center">
            <a href="{{ route('admin.offers.index') }}" class="btn btn-outline-success font-weight-bolder"><i
...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container-fluid">
        {!! Form::open(['route' => ['admin.offers.update', $offer->id], 'class' => 'form-horizontal', 'id' =>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content mt-5">
                            ...
                            <input type="hidden" name="post[{{ $language['id'] }}]"
                                value="{{ $language['id'] == $preferredLanguage ? $offer->id : $langContent[$language['id']][0]->id ?? '' }}">

                            <input type="hidden" name="layout[{{ $language['id'] }}]" value="1">
                            <div id="aa-{{ $language['id'] }}"
                                class="tab-pane fade in {{ $count == 0 ? 'active show' : '' }}">
                                <div class="form-group">
                                    <label class="control-label">Title <span class="text-danger">*</span></label>
                                    {!! Form::text('title[' . $language['id'] . ']', $language['id'] ==
                                    $preferredLanguage ? $offer->title : $langContent[$language['id']][0]->title ?? '',
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    $preferredLanguage ? $offer->layout : $langContent[$language['id']][0]->layout ??
                                    '', ['class' => 'form-control', 'placeholder' => 'link Name']) !!}
                                </div> --}}
                                <div class="form-group">
                                    <label class="control-label">Excerpt</label>
                                    {!! Form::textarea('excerpt[' . $language['id'] . ']', $language['id'] ==
                                    $preferredLanguage ? $offer->excerpt : $langContent[$language['id']][0]->excerpt ??
                                    '', ['class' => 'form-control', 'id' => '', 'maxlength' => 255, 'rows' => 3]) !!}
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Description <span class="text-danger">*</span></label>
                                    {!! Form::textarea('description[' . $language['id'] . ']', $language['id'] ==
                                    $preferredLanguage ? $offer->description :
            ...
            <div class="col-12 col-md-4">
                <div class="card card-custom gutter-b">
                    <div class="card-body">
                        <div class="form-group">
                            <div class="checkbox-inline">
                                <label class="checkbox checkbox-lg">
                                    <input type="checkbox" name="is_active" value="1" {{ $offer->is_active == 1 ?
                            ...
                            <div class="checkbox-inline">
                                <label class="checkbox checkbox-lg">
                                    <input type="checkbox" name="show_in_notification" value="1" {{
                                        $offer->show_in_notification == 1 ? 'checked' : '' }}><span></span>Show in
                                    Notification.
                                </label>
                            </div>
                        </div>
                        @if (SettingHelper::setting('visible_in') == 1)
                        @include('admin.inc.visible', ['visibleIn' => $offer->visible_in])
                        @endif
                        @if (SettingHelper::setting('banner_image') == 1)
                        @if (file_exists('storage/thumbs/' . $offer->banner) && $offer->banner != '')
                        <div class="banner-wrap mb-2">
                            <div class="bg-gray-300 mb-2 px-3 py-2"><small>Existing Image Preview</small></div>
                            <div class="card card-custom overlay">
                                <div class="card-body p-0">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('storage/' . $offer->banner) }}" alt=""
                                            class="w-100 rounded" />
                                    </div>
                                    <div class="overlay-layer">
                                        <a href="#" class="btn btn-icon btn-danger btn-shadow btn-delete"
                                            data-action="{{ route('admin.offers.destroy-image', $offer->id) }}"
                        ...
                        @endif
                        @if (file_exists('storage/thumbs/' . $offer->image) && $offer->image != '')
                        <div class="image-wrap mb-2 d-none">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('url', $offer->url, ['class' => 'form-control', 'placeholder' => 'Page link']) !!}
                        </div>
                        <div class="form-group">
                            <div class="checkbox-inline">
                                <label class="checkbox checkbox-lg">
                                    <input type="checkbox" name="link_target" value="1" {{ $offer->link_target == 1 ?
