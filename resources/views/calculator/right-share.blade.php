...
@section('script')
<script>
    $('#rightshare-form').on('submit', function(e) {
        e.preventDefault();
        var marketPrice = $('#market-price').val();
        var percent = $('#percent').val();
        var parValue = 0;
        parValue = (1 + (percent / 100))
        var value = parseFloat(marketPrice) + parseFloat(percent);
        parValue = value / parValue;
        $('.par-value-wrap').removeClass('hidden');
        $('#par-value').val(round2Fixed(parValue));
    });
    ...
    $('.clear-btn').on('click', function() {
        $('.par-value-wrap').addClass('hidden');
    });
</script>
@endsection
@section('page-banner')
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 maintxt">
                <form method="post" action="" id="rightshare-form" autocomplete="off">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            <label>% of Right Share</label>
                            <input class="form-control" type="number" min="0" id="percent" name="percent" placeholder="Numbers Only" required>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 par-value-wrap hidden">
                        <div class="form-group">
                            <label>Par Value</label>
                            <input class="form-control" type="number" min="0" id="par-value" name="par_value" placeholder="Numbers Only" readonly disabled>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                ...
                <div class="col-xs-12 col-sm-6 col-md-12">
                    <div class="sidebox">
                        ...
                        <ul class="abtlist">
                            ...
                            <li class="{{ $item['title'] == 'Right Share Adjustment' ? 'active-list' : '' }}">
