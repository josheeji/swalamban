    ...
    <div
        ...
        <div style="width: 90%; background: #fff; margin: auto; padding: 25px; text-align: left;">
            ...
            <div style="text-align: left; margin-top: 50px;">
                <div style="font-weight: bold;">Dear {{ $grievance->full_name }},</div>
                <br>
                <br>
                <div style="margin-bottom: 12px;">
                    <p>Thank you! We have received your grievance. Please keep the below reference ID safely.</p>
                    <p>{{ $grievance->reference_id }}.</p>
                </div>
