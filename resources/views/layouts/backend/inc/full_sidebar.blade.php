        ...
        <div class="sidebar-user-material">
            <div class="category-content">
                <div class="sidebar-user-material-content">
                    <a href="#">
                        <img src="{{ Gravatar::get(Auth::user()->email) }}" class="img-circle img-responsive">
                    </a>
                    <h6>{{ ucwords(Auth::user()->name) }}</h6>
                    <span class="text-size-small">Yeti Airlines</span>
                </div>
            ...
            <div class="navigation-wrapper collapse" id="user-nav">
                <ul class="navigation">
                    ...
                    {{--<li class="divider"></li>--}}
                    <li><a href="#"><i class="icon-cog5"></i> <span>Change Password</span></a></li>
                ...
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="disabled"><a href="../../../layout_6/LTR/index.html" id="layout6">Layout
                                    6 <span class="label label-transparent">Coming soon</span></a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li><a href="../../RTL/default/index.html"><i class="icon-width"></i>
