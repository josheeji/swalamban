    ...
    */
    ...
    public function postLogin(Request $request)
    {
        ...
        if (auth()->guard('admin')->attempt([
            ...
            return redirect()->intended('admin/dashboard')->with('flash_custom', 'You have successfully logged in.');
        }
    ...
    {
        auth()->logout();
        return redirect()->route('admin.login')->with('flash_success', 'You are successfully logged out.');
    }
}
